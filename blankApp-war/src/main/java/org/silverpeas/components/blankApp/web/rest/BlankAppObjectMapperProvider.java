 ...
 */
package org.silverpeas.components.blankApp.web.rest;
...
public class BlankAppObjectMapperProvider implements ContextResolver<ObjectMapper> {
    ...
    public ObjectMapper getContext(Class<?> type) {
        if(type != null && type.getPackage() != null
                && type.getPackage().getName().startsWith(BlankAppConstants.BASE_PACKAGE.getName())){
