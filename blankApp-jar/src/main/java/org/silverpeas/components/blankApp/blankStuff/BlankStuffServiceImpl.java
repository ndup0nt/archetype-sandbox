...
public class BlankStuffServiceImpl implements BlankStuffService {
	...
	@Override
	@Transactional
	/* the @Transactional annotation is especially useful for
	handling lazy loading issues (for instance if you have to deal with an existing entity
	and a lazy initialized collection in the same method) */
